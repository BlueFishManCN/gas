		...
		if ($this->input->method(TRUE) == 'GET' or $this->input->method(TRUE) == 'OPTIONS') {
			...
			if ($ampId != '') {
				...
				if ($data['AMP_Family'] != null) {
					...
					$data['AMP_Feature'][0]["SA.Group1.residue0"] = trim(rtrim(sprintf("%.4f", $data['AMP_Feature'][0]["SA.Group1.residue0"]), '0'), '.');
					$data['AMP_Feature'][0]["SA.Group2.residue0"] = trim(rtrim(sprintf("%.4f", $data['AMP_Feature'][0]["SA.Group2.residue0"]), '0'), '.');
					$data['AMP_Feature'][0]["SA.Group3.residue0"] = trim(rtrim(sprintf("%.4f", $data['AMP_Feature'][0]["SA.Group3.residue0"]), '0'), '.');
					$data['AMP_Feature'][0]["HB.Group1.residue0"] = trim(rtrim(sprintf("%.4f", $data['AMP_Feature'][0]["HB.Group1.residue0"]), '0'), '.');
					$data['AMP_Feature'][0]["HB.Group2.residue0"] = trim(rtrim(sprintf("%.4f", $data['AMP_Feature'][0]["HB.Group2.residue0"]), '0'), '.');
					$data['AMP_Feature'][0]["HB.Group3.residue0"] = trim(rtrim(sprintf("%.4f", $data['AMP_Feature'][0]["HB.Group3.residue0"]), '0'), '.');
